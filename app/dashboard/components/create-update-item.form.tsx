...
import { addDocument, createUser, setDocument, upadateUser, updateDocument, uploadBase64 } from "@/lib/firebase";
import React, { useEffect, useState } from "react";
import { LoaderCircle } from "lucide-react";
import toast from "react-hot-toast";
import { User } from "@/interfaces/user.interface";
import { ItemsImage } from "@/interfaces/item-image.interface"
...
export function CreateUpdateItem({ children, itemToUpdate }: CreateUpdateItemProps) {
    const user = useUser();
    ...
    const formSchema = z.object({
        ...
        price: z.coerce.number().gte(0, "The mininum value must be 0"),
        soldUnits: z.coerce.number().gte(0, "The mininum value must be 0")
    })
    ...
    // ==== Submit : Create or Update a item ====
